...
public:
	...
	typedef void (*DummyFn)(void* user_arg);
	...
	double Maximize(int iter_max, double gap_threshold, UpperBoundFn F_upper=NULL, DummyFn F_dummy=NULL);
...
private:
	...
	double ProjectAndComputeSubgradient(double* vars, double* g, DummyFn F_dummy=NULL);
};
