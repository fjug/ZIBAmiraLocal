...
#include <mypackage/MyDisplayVertices2.h> // header of this class

#include <Inventor/nodes/SoCube.h>
#include <Inventor/nodes/SoTranslation.h>
#include <Inventor/nodes/SoMaterial.h>

HX_INIT_CLASS(MyDisplayVertices2,HxModule)

MyDisplayVertices2::MyDisplayVertices2() :
...
void MyDisplayVertices2::compute()
{
    int i;
    ...
    // Insert material node.
    SoMaterial* material = new SoMaterial;
    material->diffuseColor = portColormap.getColor(numTriPerVertex);
...
int MyDisplayVertices2::parse(Tcl_Interp* t, int argc, char **argv)
{
