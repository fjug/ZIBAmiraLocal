...
#include <hxcore/HxPortRadioBox.h>    // provides float text input
#include <hxfield/HxUniformScalarField3.h>  // class representing 3D images

#include "parametric.h"
#include "api.h"

class PARAMAXFLOW_API ParamaxflowWithMap : public HxCompModule
{
    HX_HEADER(ParamaxflowWithMap);
  ...
  public:
	...
	Parametric* buildGraph(HxUniformScalarField3* field, HxUniformScalarField3* map, 
						   bool is3d,
	...
	HxConnection portProbMap;
	HxPortRadioBox portIs3d;
