...
#include "Paramaxflow.h"
#include "api.h"
#include "parametric.h"

HX_INIT_CLASS(Paramaxflow,HxCompModule)

Paramaxflow::Paramaxflow() :
...
Parametric* Paramaxflow::buildGraph(HxUniformScalarField3* field, double k1, double k1_mean, double k1_sd, double k2, double k3x, double k3x_mean, double k3x_sd, double k3y, double k3y_mean, double k3y_sd, double k3z, double k3z_mean, double k3z_sd)
{
	long k, N, nodeNum = 3;
...
void Paramaxflow::compute()
{
	...
	Parametric* p = buildGraph(field,k1,k1_mean,k1_sd,k2,k3x,k3x_mean,k3x_sd,k3y,k3y_mean,k3y_sd,k3z,k3z_mean,k3z_sd);
